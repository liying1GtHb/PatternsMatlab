...
% touching it at (R,0). The smaller circle roll clockwise along the big
% circle's circumference. The program traces the movement of the point P
% initially located at (R,0);
% Input parameter:
% R: radius of the big circle;
% r: radius of the small circle;
% rot: number of rotations the small circle roll around;
